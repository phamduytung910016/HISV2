...
import com.ibme.pacs.exception.StorageException;
import com.ibme.pacs.exception.StorageFileNoFoundException;
...
public class FileSystemStorageServiceImpl implements StorageService {
    ...
    public Resource loadAsResource(String filename){
        try{
            ...
            throw new StorageFileNoFoundException("could not read file: " + filename);
        }catch (Exception e){
            throw new StorageFileNoFoundException("Could not read file: " + filename);
        }
    }
